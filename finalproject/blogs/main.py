...
change = "deadlift_1"
again = "Videos/"+change+".mp4"
cap = cv2.VideoCapture(again)
...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    while cap.isOpened():
        ...
        if change == 'deadlift_1':
            if angle < 170:  # การยืดแขน ถ้าแขนงอจนต่ำกว่า 170 องศา จะถือว่าผิด ขึ้นสีแดง
                stage = "Error"
                checkdeadliftrightred += 1
                sumarmrightred3 += 1
                cv2.rectangle(image, (0, 0), (225, 73), (0, 0, 255), -1)
                # print(stage)
            elif anglekneeleft > 160:  # ถ้างอน้อยกว่า 160 องศาจะถือว่าผิด ขึ้นสีแดง
                stage = "Error"
                ...
                # print(stage)
            elif anglekneeleft < 150:  # ถ้างอขาเกิน 170 องศาจะถือว่าผิด ขึ้นสีแดง
                stage = "Error"
                checkdeadliftrightred += 1
                sumkneerightred3 += 1
                cv2.rectangle(image, (0, 0), (225, 73), (0, 0, 255), -1)
